function onCreate()
	-- background shit
	makeLuaSprite('street1-distorsionate', 'street1-distorsionate', -600, -300);
	setScrollFactor('street1-distorsionate', 0.9, 0.9);
	...
	addLuaSprite('street1-distorsionate', false);
	addLuaSprite('street1-distorsionate', false);
	addLuaSprite('street1-distorsionate', false);
